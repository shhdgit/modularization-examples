...
[拆分成什么呢?]: docs/Modules "文件、文件夹、Git仓库"
[Part.1 代码防腐]: docs/Part1/README "Part.1 代码防腐"
[Part.2 只对自己写的代码负责]: docs/Part2/README "Part.2 只对自己写的代码负责"
[Part.3 突出大逻辑，隐藏小细节]: docs/Part3/README "突出大逻辑，隐藏小细节"
